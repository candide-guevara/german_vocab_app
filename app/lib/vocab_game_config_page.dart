  ...
  Widget builderAfterLoad(final BuildContext context, final bool _) {
    ...
    final cnt_slider = ListenableBuilder(
      ...
      builder: (ctx, child) => IntSlider(
        ...
        onChanged: (v) async { conf.word_cnt = v; await conf.save(GameConfig.kVocabKey); }),
    );
    final frq_slider = ListenableBuilder(
      ...
      builder: (ctx, child) => IntSlider(
        ...
        onChanged: (v) async { conf.min_freq = v; await conf.save(GameConfig.kVocabKey); }),
    );
    final fal_slider = ListenableBuilder(
      ...
      builder: (ctx, child) => IntSlider(
        ...
        onChanged: (v) async { conf.inc_fail = v; await conf.save(GameConfig.kVocabKey); }),
    );
    final eng_switch = ListenableBuilder(
      ...
      builder: (ctx, child) => LabelledSwitch(
        ...
        onChanged: (v) async {
          ...
          await conf.save(GameConfig.kVocabKey);
        }),
    );
